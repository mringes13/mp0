...
func plot(gmpToRuntime map[int]int64) {
	...
	scatter.SetGlobalOptions(charts.WithTitleOpts(
		opts.Title{
			...
			Subtitle: "Automatically generated by GO. Written by Steve Huang, Asher Kang, & Maria Ringes",
			SubLink:  "",
		}),
	)
...
func main() {
	...
	fmt.Printf("(1) We will now compare the runtime of the programs against all possible values of GOMAXPROCS. \n")
	i := 0
	for i < gmp+1 {
